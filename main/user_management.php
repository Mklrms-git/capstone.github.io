...
if ($action === 'toggle_status' && $user_id) {
    ...
    // Preserve iframe parameter in redirect
    $is_iframe = isset($_GET['iframe']) && $_GET['iframe'] == '1';
    $iframe_param = $is_iframe ? '&iframe=1' : '';
    $redirect_type = $_GET['type_filter'] ?? $user_type;
    header("Location: user_management.php?type=" . urlencode($redirect_type) . $iframe_param);
    exit();
}
...
<style>
/* Hide sidebar when in iframe mode */
...
<div class="user-management-main">
    ...
    <div class="search-box">
        <form method="GET" class="d-flex gap-2">
            ...
            <?php if ($search): ?>
                <a href="user_management.php?type=<?php echo urlencode($user_type); ?><?php echo $iframe_param; ?>" class="btn btn-secondary"><i class="fas fa-times me-2"></i>Clear</a>
            <?php endif; ?>
        </form>
    </div>
    ...
    <ul class="nav nav-tabs user-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link <?php echo $user_type === 'all' ? 'active' : ''; ?>" href="user_management.php?type=all<?php echo $iframe_param; ?>">
                <i class="fas fa-users me-2"></i>All Users
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo $user_type === 'admin' ? 'active' : ''; ?>" href="user_management.php?type=admin<?php echo $iframe_param; ?>">
                <i class="fas fa-user-tie me-2"></i>Admins
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo $user_type === 'doctor' ? 'active' : ''; ?>" href="user_management.php?type=doctor<?php echo $iframe_param; ?>">
                <i class="fas fa-user-md me-2"></i>Doctors
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo $user_type === 'patient' ? 'active' : ''; ?>" href="user_management.php?type=patient<?php echo $iframe_param; ?>">
                            ...
                            <div class="text-end">
                                ...
                                <div class="action-buttons mt-2">
                                    ...
                                    <?php if ($user['id'] != $_SESSION['user_id']): ?>
                                        <a href="user_management.php?action=toggle_status&id=<?php echo $user['id']; ?>&type=staff&type_filter=<?php echo urlencode($user_type); ?><?php echo $iframe_param; ?>" 
                                        ...
                                        <a href="user_management.php?action=delete&id=<?php echo $user['id']; ?>&type=staff&type_filter=<?php echo urlencode($user_type); ?><?php echo $iframe_param; ?>" 
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="text-end">
                                ...
                                <div class="action-buttons mt-2">
                                    ...
                                    <a href="user_management.php?action=toggle_status&id=<?php echo $patient['id']; ?>&type=patient&type_filter=<?php echo urlencode($user_type); ?><?php echo $iframe_param; ?>" 
                                    ...
                                    <a href="user_management.php?action=delete&id=<?php echo $patient['id']; ?>&type=patient&type_filter=<?php echo urlencode($user_type); ?><?php echo $iframe_param; ?>" 
                                       class="btn btn-sm btn-danger confirm-action"
...
<div class="modal fade" id="addStaffModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" id="staffUserForm" action="user_management.php?type=<?php echo urlencode($user_type); ?><?php echo $iframe_param; ?>">
...
<div class="modal fade" id="addPatientModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" id="patientUserForm" action="user_management.php?type=<?php echo urlencode($user_type); ?><?php echo $iframe_param; ?>">
